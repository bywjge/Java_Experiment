package Chapter12.One.MorePractice;
...
public class AnalysisResult {
    public static void main(String[] args) throws URISyntaxException {
        File fRead = new File(Objects.requireNonNull(Chapter12.One.MorePractice.AnalysisResult.class.getResource("score.txt")).toURI());
        try {
