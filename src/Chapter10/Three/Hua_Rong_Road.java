...
public class Hua_Rong_Road extends JFrame implements MouseListener,KeyListener,ActionListener {
    ...
    public void init() {
        ...
        //根据按钮大小改变图片大小
        ImageIcon caoCao = new ImageIcon(Objects.requireNonNull(getClass().getResource("cc.jpeg")));
        Image temp = caoCao.getImage().getScaledInstance(person[0].getWidth(), person[0].getHeight(), Image.SCALE_DEFAULT);
        caoCao = new ImageIcon(temp);
